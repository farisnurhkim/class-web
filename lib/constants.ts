...
Jadwal untuk kelas ${kelas}:\n`;
  ...
  Website: https://tb-xiirpl1-24.vercel.app -> web ini hanya one page/1 halaman ada 5 menu link (Home, Structure, Students, Gallery, Chat). dihalaman home berisi informasi tentang instagram kelas (terdapat button yang mengarah ke instagram kelas) dan juga logo Rekayasa Perangkat Lunak dan informasi wali kelas. di halaman Structure berisi informasi tentang struktur kelas, Students berisi informasi Siswa, dihalaman Gallery berisi Foto dan video,di halaman Chats berisi Chat realtime. lalu ada button yang posisinya fixed bottom yang akan men triger modal Ai (chatbot asisten kelas xii rpl 1). lalu ada footer yang menampilkan informasi tentang sekolah, usefull Links, instagram kelas.
